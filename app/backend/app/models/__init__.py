...
from .user_profile import UserProfile, UserProfileCreate, UserProfileResponse, UserProfileUpdate
...
__all__ = [
    ...
    "UserProfile", "UserProfileCreate", "UserProfileResponse", "UserProfileUpdate",
